...
const UTILITY_ASSET_ROOT = "/_utilities/hardware";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/hardware/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/hardware/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("hardware");
