...
describe("MFE utility manifest", () => {
    it("returns a versioned installable manifest for the current utility", async () => {
        const response = createUtilityManifestResponse({
            ...
            startUrl: "/en/utilities/categories/hardware/card-draw-odds-calculator/",
        ...
        expect(manifest.icons[0]?.src).toContain("/_utilities/hardware/images/card-draw-odds-calculator.webp?version=");
