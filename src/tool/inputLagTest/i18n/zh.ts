...
export const content: ToolLocaleContent<InputLagTestUI> = {
  ...
  seo: [
    ...
    { type: 'stats', items: [
      { value: '< 10 ms', label: '电竞目标', trend: { value: '竞技环境参考', positive: true } },
      { value: '1000 Hz', label: '常见 USB 轮询', trend: { value: '输入间隔 1 ms', positive: true } },
      { value: '240 Hz', label: '高刷新率显示器', trend: { value: '帧间隔 4.16 ms', positive: true } },
      { value: '16.6 ms', label: '60 Hz 间隔', trend: { value: '每帧基础值', positive: true } },
    ], columns: 4 },
    ...
    { type: 'comparative', columns: 3, items: [
      { title: '游戏鼠标', description: '高频率 2.4GHz 无线或有线连接。', highlight: true, points: ['1000Hz 至 8000Hz 轮询率', '无消抖延迟的光学微动', '极低运动延迟的传感器'] },
      { title: '机械键盘', description: '带按键消抖控制的矩阵扫描。', highlight: true, points: ['Rapid Trigger 磁轴', '高频矩阵扫描', '可自定义触发行程'] },
      { title: '移动触摸屏', description: '覆盖在面板上的电容式触控层。', highlight: true, points: ['120Hz-480Hz 触控采样率', '系统合成器延迟', '防误触过滤算法'] },
    ] },
